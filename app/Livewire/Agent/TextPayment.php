...
class TextPayment extends Component
{
    ...
    {
        // Call calculateTax whenever any relevant property is updated
        if (in_array($propertyName, ['taxType', 'recipientType', 'residencyStatus', 'amount'])) {
            $this->calculateTax();
        }
    }
    ...
    {
        return view('livewire.agent.text-payment');
    }
}
